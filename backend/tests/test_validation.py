...
class TestAmountValidation:
    ...
    async def test_zero_amount(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"title": "Test", "amount": 0, "category": "Food & Dining", "date": "2024-07-15"},
        )
        assert response.status_code == 422
...
class TestTitleValidation:
    async def test_empty_title(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"title": "", "amount": 10.0, "category": "Food & Dining", "date": "2024-07-15"},
        )
        assert response.status_code == 422
...
class TestCategoryValidation:
    async def test_invalid_category(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"title": "Test", "amount": 10.0, "category": "Invalid", "date": "2024-07-15"},
        )
        assert response.status_code == 422
    ...
    async def test_valid_category(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"title": "Test", "amount": 10.0, "category": "Utilities", "date": "2024-07-15"},
        )
        assert response.status_code == 201
...
class TestMissingFields:
    async def test_missing_title(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"amount": 10.0, "category": "Food & Dining", "date": "2024-07-15"},
        )
        assert response.status_code == 422
    ...
    async def test_missing_amount(self, client):
        response = await client.post(
            "/api/v1/expenses",
            json={"title": "Test", "category": "Food & Dining", "date": "2024-07-15"},
        )
        assert response.status_code == 422
